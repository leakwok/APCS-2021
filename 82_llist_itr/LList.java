...
//Q: Why no "implements Iterable" ? A: If LList<T> implemented Iterable, it would have to put in the methods of that interface instead of interface List<T>.
{
  ...
  {
    /* YOUR CODE HERE */
    Iterator<T> myItr = new MyIterator();
    return myItr;
  }
  ...
  private class MyIterator implements Iterator<T>
  {
    ...
    public boolean hasNext() 
    {
      ...
      //if null, there are no more elements
